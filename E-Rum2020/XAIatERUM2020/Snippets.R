...
#
# 7. it is easier to compare models performance with charts
...
#
# 8. Let's focus on a single observation
...
#
# 9. Variable attributions - Shapley values
...
mp_ranger <- model_parts(exp_ranger, type = "ratio")
...
#
# 17. Model profile - average across individual CPs
...
#
# 18. Model profile - average calculated in groups
...
#
# 19. Model profile - average calculated in clusters
